...
public class MainActivity extends AppCompatActivity {
    ...
    private DBHelper dbHelper;
     Button mode,toggle,square,xpowy,log,sin,cos,tan,sqrt,fact, naturallog, percent, inverse, closebracket;
     Button history;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        e1 = (EditText) findViewById(R.id.tvInput);
        e2 = (EditText) findViewById(R.id.tvOutput);
        ...
        e1.setOnTouchListener(new View.OnTouchListener(){
            ...
            public boolean onTouch(View v, MotionEvent event) {
                int inType = e1.getInputType(); // backup the input type
                e1.setInputType(InputType.TYPE_NULL); // disable soft input
                e1.onTouchEvent(event); // call native handler
                e1.setInputType(inType); // restore input type
        ...
        closebracket.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                e1.setText(e1.getText().toString() + e2.getText().toString() + ")");

                text2 = e1.getText().toString();


                text1 = text2.replaceAll("÷", "/");
                text3 = text1.replaceAll("×", "*");
                ...
                try {
                    ...
                    finalResult = rhino.evaluateString(scriptable,text3, "javascript", 1, null).toString();
                } catch (Exception e) {
                    finalResult = "0";
                }

                e1.setText("" + finalResult);
                dbHelper.insert("SCIENTIFIC", text3 + " = " + finalResult);
                e2.setText("");
        ...
        percent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                e1.setText(text + e2.getText().toString() + "%");
                e2.setText("");
                ...
                text1 = text2.replaceAll("÷", "/");
                text3 = text1.replaceAll("×", "*");
                textfinal = text3.replaceAll("%", "/100");
                ...
                try {
                    Scriptable scriptable = rhino.initStandardObjects();
                    finalResult = rhino.evaluateString(scriptable,textfinal, "javascript", 1, null).toString();
                } catch (Exception e) {
                    finalResult = "0";
                }

                e1.setText("" + finalResult);
                dbHelper.insert("SCIENTIFIC", textfinal + " = " + finalResult);
        ...
        about.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, TabAboutFragment.class);

                intent.putExtra("calcName", "SCIENTIFIC");

                startActivity(intent);
                overridePendingTransition(R.anim.left_to_right, R.anim.activity_stay);
